...
const CHANGELOG = [
  { date: "7.30", text: "무기 평가에서 본인 한줄평 삭제 버튼 추가" },
  { date: "7.30", text: "무기 평가: 하트/한줄평 분리 + 한줄평 공감(👍) 기능, 자세히 보기에서 전체 한줄평 보기 추가" },
  { date: "7.30", text: "무기 상세 패널에 하트+한줄평 평가 기능 추가 (반대 표시는 없음)" },
