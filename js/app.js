...
const CHANGELOG = [
  { date: "9.8", text: "자세히 보기: 하부 총열 산탄 탭으로 전환할 때 레이아웃이 옆으로 밀리던 문제 수정" },
  { date: "9.8", text: "르맷/드릴링/헤이메이커 하부 총열 산탄 스탯 보완(발사속도·사이클타임·반동·재장전·탄속 등)" },
  { date: "9.8", text: "터미누스/터미누스 쇼티 스탯 및 한방컷(OHK) 거리 실측치로 정정" },
  { date: "9.8", text: "버제스 한방컷(OHK) 거리 데이터 추가" },
  { date: "8.31", text: "샷건 \"버제스\" 및 파생형(바요넷/트라우마) 추가" },
  { date: "8.18", text: "사무소(인력 사무소/매칭 게시판) 시범 운영 종료 — 기능 제거" },
