...
const AMMO_TYPES = {
  ...
  burgess_slug: {
    ...
    // 슬러그는 단일 탄자라 불안정 구간 없이 보장거리에서 바로 불가로 전환됨 (사용자 실측)
    // ⚠ 게임 내에서 정확히 14미터 지점에 서서 쏠 방법이 없음 — 13.9m까지만 확인됨(사용자 확인).
    // 14m에서도 한방일 가능성이 높지만 정확히 그 지점에서 쏠 수 없음 — 보수적으로 13.9로 기록.
  ...
  dolch96_special: {
    ...
    description: "기본탄.",
    cost: 0,
    // 사용자 실측(가슴 정조준 기준): 20m 97, 50m 53, 80m 46, 100m 46(80m 이후 평탄)
    falloff: [
      [0, 1.00],
      [20, 1.00],
      [50, 0.5464],
...
const ITEMS = [
  ...
  {
    // 신규 Scarce Trait. 이미지는 추후 추가 예정
    id: "trait_crack_shot",
    category: "trait",
    name: "Crack Shot",
    nameKo: "명사수",
    image: "images/traits/trait_crack_shot.png",
    detailImage: "images/traits/trait_crack_shot_detail.png",
    traitClass: "attack",
    traitTags: ["scarce"],
    price: null,
    stats: {},
  ...
  {
    // 신규 Scarce Trait. 이미지는 추후 추가 예정
    id: "trait_blademancer",
    category: "trait",
    name: "Blademancer",
    nameKo: "블레이드맨서",
    image: "images/traits/trait_blademancer.png",
    detailImage: "images/traits/trait_blademancer_detail.png",
    traitClass: "support",
    traitTags: ["scarce"],
    price: null,
    stats: {},
    description: "다크사이트 사용 중 정면에 있는 회수 가능한 탄약이 자동으로 인벤토리로 돌아온다(100m).",
    variants: [],
  },
  {
  ...
  },
  {
    ...
    // ⚠ Burn 특성이지만 월드 드랍(Scarce)이 아니라 다른 일반 특성들처럼 업그레이드
    // 포인트 2점으로 구매하는 방식이라 scarce 태그는 붙이지 않고 price:2로 표기(사용자 확인).
    id: "trait_chupacabra",
    category: "trait",
    name: "Chupacabra",
    nameKo: "추파카브라",
  ...
  {
    // 신규 Scarce Trait. 이미지는 추후 추가 예정
    id: "trait_corpse_seer",
    category: "trait",
    name: "Corpse Seer",
    nameKo: "시체를 보는 자",
    image: "images/traits/trait_corpse_seer.png",
    detailImage: "images/traits/trait_corpse_seer_detail.png",
    traitClass: "support",
    traitTags: ["scarce"],
    price: null,
    stats: {},
    description: "쓰러진 헌터를 루팅하면 다크사이트 부스트를 받는다.",
    variants: [],
  },
  {
